...
Phase 1 liefert das funktionsfähige Grundgerüst: Registrierung/Login, eine interaktive Leaflet-Karte mit Bänken, und das Eintragen neuer Bänke per Kartenklick mit der Option den aktuellen Standort zu wählen.
