...
| `outline` | `border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#262b1f]` |
...
- Input: `w-full pl-9 pr-9 py-2 text-sm rounded-lg border border-gray-200 dark:border-[#2a2f24] bg-white dark:bg-[#1e231a] text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent`
